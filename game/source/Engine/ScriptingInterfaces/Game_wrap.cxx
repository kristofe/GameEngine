...
#define SWIG_import  luaopen_example
...
extern "C" {
#endif
static int _wrap_Game_TestLuaCallback(lua_State* L) {
  int SWIG_arg = -1;
  
  Game::TestLuaCallback();
  SWIG_arg=0;
...
static int _wrap_delete_Game(lua_State* L) {
  int SWIG_arg = -1;
  Game *arg1 = (Game *) 0 ;
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Game,0))){
    SWIG_fail_ptr("delete_Game",1,SWIGTYPE_p_Game);
  }
...
swig_lua_class _wrap_class_Game = { "Game", &SWIGTYPE_p_Game,_wrap_new_Game, swig_delete_Game, swig_Game_methods, swig_Game_attributes, swig_Game_bases };
...
static const struct luaL_reg swig_commands[] = {
    { "Game_TestLuaCallback", _wrap_Game_TestLuaCallback},
    { "new_Game", _wrap_new_Game},
    { "delete_Game", _wrap_delete_Game},
    {0,0}
};
