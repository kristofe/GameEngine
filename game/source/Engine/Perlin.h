...
static int noise_permutation[512] = { 151,160,137,91,90,15,
...
public:
		...
		static float Noise(float x, float y)
		{
			...
			B = noise_permutation[X+1]+Y, BA = noise_permutation[B], BB = noise_permutation[B+1];      // THE 8 CUBE CORNERS,
		...
		static float Noise(float x, float y, float z) {
			...
			v = fade(y),                                // FOR EACH OF X,Y,Z.
			w = fade(z);
			int A = noise_permutation[X  ]+Y, AA = noise_permutation[A]+Z, AB = noise_permutation[A+1]+Z,      // HASH COORDINATES OF
			B = noise_permutation[X+1]+Y, BA = noise_permutation[B]+Z, BB = noise_permutation[B+1]+Z;      // THE 8 CUBE CORNERS,
