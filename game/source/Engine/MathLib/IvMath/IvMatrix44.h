...
public:
    ...
    // manipulators
    void SetRows( const IvVector4& row1, const IvVector4& row2, const IvVector4& row3, const IvVector4& row4 ); 
    void GetRows( IvVector4& row1, IvVector4& row2, IvVector4& row3, IvVector4& row4 ); 
	void GetRows( IvVector3& row1, IvVector3& row2, IvVector3& row3, IvVector3& row4 ); 

    void SetColumns( const IvVector4& col1, const IvVector4& col2, const IvVector4& col3, const IvVector4& col4 ); 
    void GetColumns( IvVector4& col1, IvVector4& col2, IvVector4& col3, IvVector4& col4 ); 
	void GetColumns( IvVector3& col1, IvVector3& col2, IvVector3& col3, IvVector3& col4 ); 
	...
	void SetPosition( const IvVector3& pos );
