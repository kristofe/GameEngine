...
IvVector4::IvVector4(const IvVector3& other, float w_val) : 
	x( other.x ),
	y( other.y ),
	z( other.z ),
	w( w_val )
...
IvVector4               
Lerp( float t, const IvVector4& a, const IvVector4& b )
{
	return ((1.0f-t)*a) + (t*b);

} 
IvVector4	IvVector4::Lerp(float t,const IvVector4& b)
{
